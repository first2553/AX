...
if game.PlaceId == 9393540912 then
else
    game.Players.LocalPlayer:kick("xxx")
end
...
local win = RadientPaid:Window("V.1.2.1")
local serv = win:Server("ZeroX Hub", "Pirate Adventure")
...
Section:Dropdown("select weapon",Weaponlist,function(currentOption)
...
Section:Line()
Section:Toggle("Check Money",false,function(v)
    spawn(function()
    while _G.a do wait()
    a = tostring(game:GetService("Players").LocalPlayer.Data.Belis.Value)
    end
    end)
    _G.Check = v
_G.a = v
spawn(function()
while _G.Check do wait(1)
    ...
    Section:Toggle("Check Levels",false,function(v)
    spawn(function()
    while _G.b do wait()
    ab = tostring(game:GetService("Players").LocalPlayer.Data.Levels.Value)
    end
    end)
    _G.Checkx = v
_G.b = v
spawn(function()
while _G.Checkx do wait(1)
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Level Check",
        Text = ab,
        Duration = 10,
...
spawn(function()
       game:GetService("RunService").RenderStepped:Connect(function()
        pcall(function()
            if _G.Farm then
 game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =game:GetService("Workspace").Bacon1.HumanoidRootPart.CFrame * CFrame.new(0,0,3)
            end
        end)
       end)
end)
...
Section:Toggle("Auto Farm money", false, function(state)
...
spawn(function()
       game:GetService("RunService").RenderStepped:Connect(function()
        pcall(function()
            if _G.Farm1 then
 game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =game:GetService("Workspace")["Rich thief"].HumanoidRootPart.CFrame * CFrame.new(0,0,3)
            end
        end)
       end)
end)
